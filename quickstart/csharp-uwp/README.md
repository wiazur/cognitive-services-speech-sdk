...
When you see the `Enable Microphone` button, click it. Then click the `Speech recognition with microphone input` button and start speaking. It will then stop and confirm what you said.
